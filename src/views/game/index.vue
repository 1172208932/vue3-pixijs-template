<template>
  <div class="box">
    ...
    <div class="bottomPart">
      ...
      <img src="" alt="">
      <div style="position: absolute;right: 68px ; bottom: 0;">2999.53 <p>USD</p>
      </div>
      <div style="position: absolute;right: 0px; bottom: 0" class="round roundSmall"><img class="mean"
          src="../../assets/mean.png"></div>
    </div>
  </div>
</template>
